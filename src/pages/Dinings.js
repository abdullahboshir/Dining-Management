...
const {handeDineId} = useAuth();
    ...
    return (
        <div className='h-screen w-screen overflow-x-hidden'>
            ...
            <div className='pt-5 pl-5 grid grid-cols-5 gap-4 w-screen mt-16'>
                         ...
                         <div className='flex flex-col'>
                               <div className='w-52 h-60 flex border-4 flex-col'>
                                ...
                                <div className=' w-52 h-52 flex items-center justify-center cursor-pointer'> 
                                   ...
                                   <Link onClick={() => handeDineId(dinings._id)} to={`/dinings/${dinings._id}`}  className='text-6xl text-green-600 hover:text-7xl duration-200'><BsBuildingsFill /></Link>
